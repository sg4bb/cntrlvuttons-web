...
import { useButtonContext } from "@/context/SelectProvider";
...
const ButtonList = () => {
  ...
  return (
    <>
      <h2 className="text-center text-1xl lg:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-blue-500 dark:from-emerald-400 dark:to-sky-700">
